...
return (
    <div className="fixed inset-0 bg-gray-500/10 dark:bg-gray-900/30 z-[9998]">
        <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-20">
            <div
            ref={modalRef}
            className={`w-[640px] rounded-xl border shadow-2xl overflow-hidden ${isDark ? 'bg-gray-800 border-gray-700':'bg-white border-gray-200'}`}
            >
                <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 text-lg font-medium dark:text-white>搜索聊天记录</h3>
                </div>
                <div className="p-4">
                    <style>
                        {`
